...
static void turn_left (LastLocationArg){LastLocation(); put_move_chip(CChipTurn::LEFT);}
static void turn_right(LastLocationArg){LastLocation(); put_move_chip(CChipTurn::RIGHT);}
